...
- current candidate product commit: `59eeffbce5efd0a73a0fed2a4f3418faf71d5852` (publication/docs head: `ff1b7ec255b29d973d7889f26dcb8cc23171a716`)
...
- per-user install: verified manifest/entry/package hashes at publication head `ff1b7ec`
...
reconciled or passed; the active product candidate is `59eeffb` (published
head `ff1b7ec`).
