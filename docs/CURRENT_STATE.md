...
- The evidence-only docs commit `134cfcd78845f6e6d9ed28a0c7cda3b410eed839` is now pushed; fresh `refs/pull/5/head` and `refs/heads/feat/semantic-arrange-v1-20260906` both read back to that SHA. PR #5 remains OPEN/Draft and `main` is untouched.
