...
- current candidate product commit: `59eeffbce5efd0a73a0fed2a4f3418faf71d5852`; publication/docs head is the live task/PR ref verified at SAV1-80
...
- per-user install: verified manifest/entry/package hashes against the live publication head
...
reconciled or passed; the active product candidate is `59eeffb` and the
publication/docs head is verified from the live task/PR ref.
